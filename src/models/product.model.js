...
const productModel = {
    getAllProduct: (transit, airline, minprice, maxprice) => {
        return new Promise((resolve, reject) => {
            let sql = `SELECT products.origin, products.destination, products.price, products.seat_class,      products.stock,
				...
				FROM products RIGHT JOIN airlines ON products.airline_id = airlines.id`;
    ...
    storeProduct: (origin, destination, price, seat_class, stock,
    ...
    updateProduct: (origin, destination, price, seat_class, stock,
        transit_total, flight_date, airline_id, estimation,
        created_date, code, gate, terminal, id) => {
        return new Promise((resolve, reject) => {
